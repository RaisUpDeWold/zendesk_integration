...
public class HelpFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView.findViewById(R.id.fragment_main_btn_rateapp).setOnClickListener(new AuthOnClickWrapper(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                final BaseZendeskFeedbackConfiguration feedbackConfiguration = new BaseZendeskFeedbackConfiguration() {
                    @Override
                    public String getRequestSubject() {
                        return "Give rating about our app";
                    }
                };

                RateMyAppDialog rateMyAppDiag = new RateMyAppDialog.Builder(getActivity())
                        .withAndroidStoreRatingButton()
                        .withDontRemindMeAgainButton()
                        .build();

                rateMyAppDiag.showAlways(getActivity());
            }
        }, ctx));

        rootView.findViewById(R.id.fragment_main_btn_givefeedback).setOnClickListener(new AuthOnClickWrapper(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                final BaseZendeskFeedbackConfiguration feedbackConfiguration = new BaseZendeskFeedbackConfiguration() {
                    @Override
                    public String getRequestSubject() {
                        return "Feedback about our app";
                    }
                };

                RateMyAppDialog rateMyAppDiag = new RateMyAppDialog.Builder(getActivity())
                        .withSendFeedbackButton(feedbackConfiguration)
                        .withDontRemindMeAgainButton()
                        .build();
